...
constexpr ptrdiff_t dwEntityList = 0x4D5239C;
constexpr ptrdiff_t dwForceAttack = 0x3183920;
constexpr ptrdiff_t dwForceAttack2 = 0x318392C;
constexpr ptrdiff_t dwForceBackward = 0x31838D8;
constexpr ptrdiff_t dwForceForward = 0x3183944;
constexpr ptrdiff_t dwForceJump = 0x51FBFA8;
constexpr ptrdiff_t dwForceLeft = 0x31838CC;
constexpr ptrdiff_t dwForceRight = 0x31838F0;
constexpr ptrdiff_t dwGameDir = 0x62C7F8;
constexpr ptrdiff_t dwGameRulesProxy = 0x526F2A4;
constexpr ptrdiff_t dwGetAllClasses = 0xD643A4;
constexpr ptrdiff_t dwGlobalVars = 0x58DCE8;
constexpr ptrdiff_t dwGlowObjectManager = 0x529A1D0;
constexpr ptrdiff_t dwInput = 0x51A3968;
constexpr ptrdiff_t dwInterfaceLinkList = 0x9054E4;
constexpr ptrdiff_t dwLocalPlayer = 0xD3DD14;
constexpr ptrdiff_t dwMouseEnable = 0xD438B8;
constexpr ptrdiff_t dwMouseEnablePtr = 0xD43888;
constexpr ptrdiff_t dwPlayerResource = 0x3181C70;
constexpr ptrdiff_t dwRadarBase = 0x51870FC;
constexpr ptrdiff_t dwSensitivity = 0xD43754;
constexpr ptrdiff_t dwSensitivityPtr = 0xD43728;
constexpr ptrdiff_t dwSetClanTag = 0x8A0E0;
constexpr ptrdiff_t dwViewMatrix = 0x4D43CB4;
constexpr ptrdiff_t dwWeaponTable = 0x51A442C;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xD43518;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD487B8;
...
constexpr ptrdiff_t m_yawClassPtr = 0xD43518;
constexpr ptrdiff_t m_pitchClassPtr = 0x51873A0;
...
constexpr ptrdiff_t r_model_ambient_min = 0x59105C;
constexpr ptrdiff_t set_abs_angles = 0x1D4400;
constexpr ptrdiff_t set_abs_origin = 0x1D4240;
constexpr ptrdiff_t is_c4_owner = 0x3AD890;
constexpr ptrdiff_t force_update_spectator_glow = 0x3A0E02;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x2F6C1BE0;
